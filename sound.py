...
class Sound:
    def __init__(self):
        ...
        self.alien_explosion = pg.mixer.Sound('sounds/alien_explosion.mp3')
        self.ship_explosion = pg.mixer.Sound('sounds/ship_explosion.mp3')
        self.end_theme = pg.mixer.Sound('sounds/bgm.mp3')
    ...
    def play_bg(self): self.play_music('sounds/bgm.mp3')
    ...
    def play_fire_phaser(self):
        pg.mixer.music.set_volume(0.3)
        self.play_sound(self.alien_phaser)
    def play_fire_photon(self):
        pg.mixer.music.set_volume(0.2)
        self.play_sound(self.ship_photon)
    def play_alien_explosion(self):
        self.ship_explosion= pg.mixer.music.set_volume(10)
